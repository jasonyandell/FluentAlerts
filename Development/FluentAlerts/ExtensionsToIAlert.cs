...
namespace FluentAlerts
{
    ...
    public static class ExtensionsToIAlert
    {
        ...
        /// <returns></returns>
        public static string ToText(this IAlert source, Func<string,string> modifyResults = null)
        {
            var s = new AlertSerializerToText();
            return s.Serialize(source, modifyResults);
        }

        public static string ToHtml(this IAlert source, Func<string, string> modifyResults = null)
        {
